...
class OrderGrpcServiceTest {
    ...
    private OrderDTO fullDto() {
        return new OrderDTO(
                10L, "ORD-20240101-000001", "user-1", "CONFIRMED",
                List.of(new OrderItemDTO(1L, 900L, "Widget", 901L, "SKU-1", "img.png",
    ...
    void getOrder_mapsDto() {
        ...
        service.getOrder(GetOrderRequest.newBuilder().setOrderId(10L).build(), observer);
        ...
        assertThat(item.getVariantId()).isEqualTo(901L);
    ...
    void getOrder_notFound() {
        ...
        service.getOrder(GetOrderRequest.newBuilder().setOrderId(99L).build(), observer);
    ...
    void getOrder_unexpectedError() {
        ...
        service.getOrder(GetOrderRequest.newBuilder().setOrderId(1L).build(), observer);
    ...
    void getOrder_nullItemFields() {
        var dto = new OrderDTO(
                10L, "ORD-20240101-000001", "user-1", "PENDING",
                List.of(new OrderItemDTO(1L, 900L, "Widget", null, null, null,
        ...
        assertThat(item.getVariantId()).isEqualTo(0L);
