...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ProductNotFoundException.class, VariantNotFoundException.class,
                        CategoryNotFoundException.class, AttrNotFoundException.class,
                        AttrValNotFoundException.class})
    ...
    @ExceptionHandler({ProductAlreadyExistsException.class, VariantSkuAlreadyExistsException.class,
                        CategoryAlreadyExistsException.class, AttrAlreadyExistsException.class})
    ...
    public ResponseEntity<ErrorResponse> invalidState(InvalidProductStateException ex, HttpServletRequest req) {
