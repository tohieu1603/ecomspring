 ...
 *
 * <p>Encodes {@code (createdAt, id)} as a URL-safe base64 string. The id is a {@code Long}
 * (BIGSERIAL) in catalog-service; epoch micros preserve ordering even when rows are
